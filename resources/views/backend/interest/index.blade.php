...
@section('inlineJS')
	...
	function ActiVeInActive(UserId)
	{
		...
		$.ajax({
		type: "GET",
		url: "/tripcrasher/backend/interest/changeStatus/"+UserId,
		data: {},
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Interest <small>Some examples to get you started</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Interest <small>Interest listing</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                      @foreach( $interest as $record )
                      @if($record->parent_id == 0)
                      
                        <tr class="">

                          <td>{{ $record->id }}</td>
                          <td>{{ $record->interest_name }}</td>
                          ...
                          <td>
                            <a href="{{ backend_url('interest/edit/'.$record->id) }}" class="btn btn-xs btn-primary edit" style="float: left;"><i class="fa fa-pencil"></i></a>

                            {!! Form::model($record, ['method' => 'delete', 'url' => 'backend/interest/'.$record->id, 'class' =>'form-inline form-delete']) !!}
