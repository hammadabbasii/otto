            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Slider Page -  <small>Fill the form to add new Image</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                        ...
                        {!! Form::open( ['url' => ['backend/slider/create'], 'method' => 'POST','files' => true, 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
