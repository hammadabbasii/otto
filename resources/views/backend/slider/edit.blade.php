            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Edit Slider Image <small></small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                        ...
                        <?php //dd($cms); ?>
                        {!! Form::model($slider, ['url' => ['backend/slider',$slider->id], 'method' => 'PUT', 'files' => true,'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
