...
<div class="form-group{{ $errors->has('slider_images') ? ' has-error' : '' }}">
    {{ Form::label('slider_images', 'slider Image', ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) }}
    <div class="col-md-6 col-sm-6 col-xs-12">
        {{ Form::file('slider_images', null, ['class' => 'form-control col-md-7 col-xs-12']) }}
    </div>
    @if ( $errors->has('slider_images') )
        <p class="help-block">{{ $errors->first('slider_images') }}</p>
    @endif
</div>
...
<div class="form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        {{ Form::submit('Save', ['class' => 'btn btn-primary']) }}
        {{ Html::link( backend_url('slider'), 'Cancel', ['class' => 'btn btn-default']) }}
    </div>
</div>
