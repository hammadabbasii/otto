        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Advertisement <small>Listing of Advertisement Images</small></h3>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Advertisement <small> Advertisement Images listing</small></h2>
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                @foreach( $advertisement as $record )
                                    <tr class="">
                                        ...
                                        <td><a class="group1" href="{{ URL::to('/') }}/public/images/advertisement/{{$record->image1}}" ><img style="width:50px;height: 50px;" src="{{ URL::to('/') }}/public/images/advertisement/{{$record->image1}}" /></a></td>
                                        <td>
                                            <a class="group1" href="{{ URL::to('/') }}/public/images/advertisement/{{$record->image2}}" >
                                                <img style="width:50px;height: 50px;" src="{{ URL::to('/') }}/public/images/advertisement/{{$record->image2}}" /></a>
                                        </td>
                                        <td>
                                            <a href="{{ backend_url('advertisement/edit/'.$record->id) }}" class="btn btn-xs btn-primary edit" style="float: left;"><i class="fa fa-pencil"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
