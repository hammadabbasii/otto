...
@section('inlineJS')
	...
	function ActiVeInActive(UserId)
	{
		...
		$.ajax({
		type: "GET",
		url: "/mobiles/backend/brand/changeStatus/"+UserId,
		data: {},
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Brand <small>Some examples to get you started</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Brand <small>Brand listing</small></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      @if($record->parent_id == 0)
                        ...
                        <tr class="">
                          ...
                          <td>
                            <a href="{{ backend_url('brand/edit/'.$record->id) }}" class="btn btn-xs btn-primary edit" style="float: left;"><i class="fa fa-pencil"></i></a>

                            {!! Form::model($record, ['method' => 'delete', 'url' => 'backend/brand/'.$record->id, 'class' =>'form-inline form-delete']) !!}
