...
<div class="form-group{{ $errors->has('full_name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
                {{ Form::text('full_name', null, ['class' => 'form-control col-md-7 col-xs-12']) }}
        </div>
...
<div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
        {{ Form::label('phone_number', 'Phone no', ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) }}
        <div class="col-md-6 col-sm-6 col-xs-12">
                {{ Form::text('phone_number', null, ['class' => 'form-control col-md-7 col-xs-12']) }}
        </div>
