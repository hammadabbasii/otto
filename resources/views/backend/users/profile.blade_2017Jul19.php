                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    {{ Html::image('public/images/'.$users['profile_picture'] , '', array( 'width' => 200, 'height' => 200 )) }}
                                </div>
                            </div>
                            <h3>{{$users['first_name'].' '.$users['last_name']}}</h3>

                            <ul class="list-unstyled user_data">
                                <li><i class="fa fa-map-marker user-profile-icon"></i> {{$users['address'] != '' ? $users['address'] : 'N/A'}}
                                </li>
...
<table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Country</td>
                                                    <td>{{$users['country'] != '' ? $users['country'] : 'N/A'}}</td>
                                                </tr>
