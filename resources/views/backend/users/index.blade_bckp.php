...
@section('inlineJS')
	...
	function ActiVeInActive(UserId)
	{
		...
		$.ajax({
		type: "GET",
		url: "/mobiles/backend/user/changeStatus/"+UserId,
		data: {},
                      ...
                      @foreach( $users as $record )
                        <tr class="">
                          ...
                          <td>
                            ...
                            {!! Form::button('<i class="fa fa-trash-o"></i> Delete ', ['class' => 'btn btn-danger btn-xs delete', 'name' => 'delete_modal', 'type' => 'submit']) !!}
                            {!! Form::close() !!}
                          </td>
                        </tr>
                      @endforeach
